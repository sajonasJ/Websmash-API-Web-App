...
const INTRSTNG = 'https://www.flickr.com/services/rest/?method=flickr.interestingness.getList&per_page=5&format=json&nojsoncallback=1&api_key=' + API_KEY;
...
function display(data) {
    ...
    for (let i = 0; i < data.length; i++) {
        htmlStr += `<figure class="scenery"><a href ="${data[i].full}">
